...
namespace CC10Part2.Models
{
    ...
    public partial class masterEntities : DbContext
    {
        ...
        [DbFunction("masterEntities", "fn_GetEmp_ByGender")]
        public virtual IQueryable<fn_GetEmp_ByGender_Result> fn_GetEmp_ByGender(string egen)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<fn_GetEmp_ByGender_Result>("[masterEntities].[fn_GetEmp_ByGender](@egen)", egenParameter);
        }
        ...
        public virtual int sp_MultyTable(Nullable<int> num)
        {
            var numParameter = num.HasValue ?
                new ObjectParameter("num", num) :
                new ObjectParameter("num", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("sp_MultyTable", numParameter);
        }
